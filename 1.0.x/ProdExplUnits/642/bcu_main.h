...
#define Enable6d5() {\
	...
	hal_set_pin_function( CYGHWR_HAL_KINETIS_PIN(B, 22, 1, KINETIS_PIN_PULLUP) );\
	hal_gpio_pin_ddr_out( CYGHWR_HAL_KINETIS_PIN(B, 22, 1, KINETIS_PIN_PULLUP) );\
	hal_gpio_pin_set( CYGHWR_HAL_KINETIS_PIN(B, 22, 1, KINETIS_PIN_PULLUP) );\
	...
	hal_set_pin_function( CYGHWR_HAL_KINETIS_PIN(E, 16, 1, KINETIS_PIN_PULLUP) );\
	hal_gpio_pin_ddr_out( CYGHWR_HAL_KINETIS_PIN(E, 16, 1, KINETIS_PIN_PULLUP) );\
	hal_gpio_pin_set( CYGHWR_HAL_KINETIS_PIN(E, 16, 1, KINETIS_PIN_PULLUP) );\
	hal_set_pin_function( CYGHWR_HAL_KINETIS_PIN(E, 17, 1, KINETIS_PIN_PULLUP) );\
	hal_gpio_pin_ddr_out( CYGHWR_HAL_KINETIS_PIN(E, 17, 1, KINETIS_PIN_PULLUP) );\
	hal_gpio_pin_set( CYGHWR_HAL_KINETIS_PIN(E, 17, 1, KINETIS_PIN_PULLUP) );\
	hal_set_pin_function( CYGHWR_HAL_KINETIS_PIN(E, 16, 1, KINETIS_PIN_PULLUP) );\
	hal_gpio_pin_ddr_out( CYGHWR_HAL_KINETIS_PIN(E, 16, 1, KINETIS_PIN_PULLUP) );\
	hal_gpio_pin_set( CYGHWR_HAL_KINETIS_PIN(E, 16, 1, KINETIS_PIN_PULLUP) );\
	hal_set_pin_function( CYGHWR_HAL_KINETIS_PIN(E, 17, 1, KINETIS_PIN_PULLUP) );\
