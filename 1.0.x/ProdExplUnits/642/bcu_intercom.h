...
extern state_process_t  d2p_moniort_state;
...
//add by zhw 2015-11-25
typedef struct pcu_to_eamp
{
//	char device_name[10];
	unsigned char emap_device_no;
//	char target_device_name[10];
	unsigned char pcu_device_no;
}pcu_to_eamp_t;
...
void D2PMoniortEnter(send_infomation_t *);
void D2PMoniortExit();
void D2PMoniortProcess(send_infomation_t *);
...
int ZhwPcuToEampMap(int input_pcu_number);
