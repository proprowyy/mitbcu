...
int touch_screen_main() {
  { wd_touch_screen = new Fl_Double_Window(800, 485, "Touch Screen");
    ...
    { wz_window_view = new Fl_Wizard(-70, -124, 920, 512);
      ...
      { gp_intercomm = new Fl_Group(0, 0, 800, 385);
        ...
        { btn_intercomm_accept = new Fl_Button(645, 80, 150, 85, "\346\216\245\351\200\232");
        ...
        { btn_intercomm_refuse = new Fl_Button(645, 185, 150, 85, "\346\214\202\346\226\255");
      ...
      { gp_static_show = new Fl_Group(0, 0, 800, 384);
        ...
        { Fl_Box* o = new Fl_Box(315, 160, 20, 20);
          o->box(FL_FLAT_BOX);
          o->color((Fl_Color)1);
          o->selection_color((Fl_Color)1);
          o->labelcolor((Fl_Color)1);
        } // Fl_Box* o
        { Fl_Box* o = new Fl_Box(315, 185, 20, 20);
          o->box(FL_FLAT_BOX);
          o->color((Fl_Color)1);
          o->selection_color((Fl_Color)1);
          o->labelcolor((Fl_Color)1);
        } // Fl_Box* o
        { Fl_Box* o = new Fl_Box(340, 135, 20, 20);
          o->box(FL_FLAT_BOX);
          o->color((Fl_Color)1);
          o->selection_color((Fl_Color)1);
          o->labelcolor((Fl_Color)1);
        } // Fl_Box* o
        { Fl_Box* o = new Fl_Box(365, 135, 20, 20);
          o->box(FL_FLAT_BOX);
          o->color((Fl_Color)1);
          o->selection_color((Fl_Color)1);
          o->labelcolor((Fl_Color)1);
        } // Fl_Box* o
        { Fl_Box* o = new Fl_Box(365, 160, 20, 20);
          o->box(FL_FLAT_BOX);
          o->color((Fl_Color)1);
          o->selection_color((Fl_Color)1);
          o->labelcolor((Fl_Color)1);
        } // Fl_Box* o
        { Fl_Box* o = new Fl_Box(365, 185, 20, 20);
          o->box(FL_FLAT_BOX);
          o->color((Fl_Color)1);
          o->selection_color((Fl_Color)1);
          o->labelcolor((Fl_Color)1);
        } // Fl_Box* o
        { Fl_Box* o = new Fl_Box(340, 160, 20, 20);
          o->box(FL_FLAT_BOX);
          o->color((Fl_Color)1);
          o->selection_color((Fl_Color)17);
          o->labelcolor((Fl_Color)18);
        } // Fl_Box* o
        { Fl_Box* o = new Fl_Box(340, 184, 20, 20);
          o->box(FL_FLAT_BOX);
          o->color((Fl_Color)1);
          o->selection_color((Fl_Color)26);
          o->labelcolor((Fl_Color)55);
        } // Fl_Box* o
        { Fl_Box* o = new Fl_Box(341, 185, 18, 18);
          o->box(FL_FLAT_BOX);
          o->selection_color((Fl_Color)1);
          o->labelcolor((Fl_Color)1);
        } // Fl_Box* o
        { Fl_Box* o = new Fl_Box(341, 161, 18, 18);
          o->box(FL_FLAT_BOX);
          o->selection_color((Fl_Color)1);
          o->labelcolor((Fl_Color)1);
        } // Fl_Box* o
        { Fl_Tile* o = new Fl_Tile(385, 145, 65, 30, "MIT");
          o->labelsize(16);
          o->align(Fl_Align(448|FL_ALIGN_INSIDE));
          o->end();
        } // Fl_Tile* o
        { Fl_Tile* o = new Fl_Tile(390, 165, 65, 35, " \351\270\243\345\225\270\344\277\241\346\201\257");
