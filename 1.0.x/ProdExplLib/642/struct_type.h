 ...
 * 系统设备个数
 */
#define CONFIG_BCU_NUM   20				///<广播控制器个数
...
#define D2P_MONITOR_EVENT  22
#define SELECT_CAR_EVENT 59
...
typedef struct
{
	...
	unsigned char d2d_intercomm_pbcu_device_no;
	unsigned char d2d_intercomm_whether_is_connecting;
}d2d_intercomm_t;
